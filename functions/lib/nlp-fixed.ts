 ...
 */
export async function parseItineraryRequest(query: string, city?: string): Promise<StructuredRequest> {
  ...
  try {
    ...
    const rawGeminiResult = await processWithGemini(query, city);
