...
exports.NYC_TIMEZONE = void 0;
exports.parseAndNormalizeTime = parseAndNormalizeTime;
...
exports.timeStringToNYCISOString = timeStringToNYCISOString;
exports.formatISOToNYCTime = formatISOToNYCTime;
const date_fns_tz_1 = require("date-fns-tz");
// Default timezone for NYC
exports.NYC_TIMEZONE = 'America/New_York';
/**
 ...
 */
function parseAndNormalizeTime(timeStr) {
    if (!timeStr)
        return "12:00"; // Default to noon if no time provided
 ...
 */
function formatTimeForDisplay(timeStr, format = 'h:mm a') {
    ...
    if (timeStr.includes('T') && timeStr.includes('Z')) {
        ...
        try {
            ...
            return (0, date_fns_tz_1.formatInTimeZone)(date, exports.NYC_TIMEZONE, format);
        }
        catch (err) {
    ...
    const nycDate = (0, date_fns_tz_1.toZonedTime)(date, exports.NYC_TIMEZONE);
    return (0, date_fns_tz_1.formatInTimeZone)(nycDate, exports.NYC_TIMEZONE, format);
}
/**
...
function addMinutesToTime(timeStr, minutesToAdd) {
    ...
    if (timeStr.includes('T') && timeStr.includes('Z')) {
        try {
            ...
            return (0, date_fns_tz_1.formatInTimeZone)(nycDate, exports.NYC_TIMEZONE, 'HH:mm');
        }
        catch (err) {
            console.warn(`Could not parse ISO timestamp: ${timeStr}, falling back to manual parsing`);
            // Fall through to the manual parsing below
 ...
 */
function getMinutesBetweenTimes(startTimeStr, endTimeStr) {
    // Process start time
    let startDate;
    ...
    const startNYC = (0, date_fns_tz_1.toZonedTime)(startDate, exports.NYC_TIMEZONE);
    const endNYC = (0, date_fns_tz_1.toZonedTime)(endDate, exports.NYC_TIMEZONE);
 ...
 */
function timeStringToNYCISOString(timeStr) {
 ...
 * @returns Formatted time string in NYC timezone
 */
function formatISOToNYCTime(isoTimestamp, format = 'h:mm a') {
    try {
